...
def _group_parameter_count(param_groups: dict[str, dict[str, nn.Parameter]]) -> dict[str, int]:
    return {group_name: len(parameters) for group_name, parameters in param_groups.items()}
